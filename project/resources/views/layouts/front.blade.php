...
@elseif(isset($productt))
	...
	@elseif(@$subcat)
	<title>{{$gs->title}}</title>
	<meta property="og:title" content="{{$subcat->meta_title}}" />
	<meta property="og:description" content="{{ $subcat->meta_description  }}" />
	
	@elseif(@$childcat)
	<title>{{$gs->title}}</title>
	<meta property="og:title" content="{{$childcat->meta_title}}" />
	<meta property="og:description" content="{{ $childcat->meta_description }}" />
	@elseif(@$cat)
	<title>{{$gs->title}}</title>
