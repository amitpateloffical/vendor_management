         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('status', function(Verification $data) {
                                ...
                                return '<div class="action-list"><select class="process select vendor-droplinks '.$class.'">'.
                                 '<option value="'. route('admin-vr-st',[$data->id,'Pending']).'" '.$s.'>Pending</option>'.
                                '<option value="'. route('admin-vr-st',[$data->id,'Verified']).'" '.$s.'>Verified</option>'.
                                '<option value="'. route('admin-vr-st',[$data->id,'Declined']).'" '.$ns.'>Declined</option></select></div>';
                            }) 
